...
//            new("Payment", category.Id, ETransactionType.Payment, -50.00m, DateTime.Now, DateTime.Now);
...
//        Category category = new("Category");
//        Transaction transaction =
//            new("Payment", category.Id, ETransactionType.Payment, -50.00m, DateTime.Now, DateTime.Now.AddDays(-2));
//        transaction.ExecutePayment(account, DateTime.Now, pay);
//        // Act
...
//        Category category = new("Category");
//        Transaction transaction =
//            new("Receipt", category.Id, ETransactionType.Receipt, 150.00m, DateTime.Now, DateTime.Now.AddDays(2));
