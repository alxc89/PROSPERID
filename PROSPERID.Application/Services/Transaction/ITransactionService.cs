...
public interface ITransactionService
{
    ...
    Task<ServiceResponse<IEnumerable<TransactionView>>> GetTransactionsAsync(int pageNumber, int pageSize);
    Task<ServiceResponse<TransactionView>> CreateTransactionAsync(CreateTransactionDTO createTransactionDTO);
    Task<ServiceResponse<TransactionView>> UpdateTransactionAsync(long id, UpdateTransactionDTO updateTransactionDTO);
